...
def test_task_registry():
    ...
    from cornserve_tasklib.task.builtins.encoder import EncoderInput, EncoderOutput, EncoderTask
    from cornserve_tasklib.task.builtins.llm import LLMUnitTask, OpenAIChatCompletionChunk, OpenAIChatCompletionRequest
